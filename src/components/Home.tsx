...
export default function Home() {
  return (
    <div className=" h-[90vh] grid grid-rows-3 justify-center items-center grid-cols-3">
      ...
      <div className="isolate aspect-video w-96 rounded-xl bg-white/20 shadow-lg backdrop-blur-sm ring-1 ring-black/5 lg:col-start-2 row-start-2 text-wrap col-start-1 m-4 lg:m-0 items-center">
        <div className="space-y-5 m-6">
          <h1 className="text-4xl font-extrabold space-y-2">
            <p className="">Hi 👋🏽</p>
            <p className="">I&apos;m Kiran Kumar</p>
          </h1>
