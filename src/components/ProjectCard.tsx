  ...
  return (
    <div className="mx-auto mt-2 max-w-3xl px-6 lg:px-8 group mb-2 ">
      <div className="mt-16 flow-root sm:mt-24 group-hover:scale-110 transition-all duration-200 ">
        <div className="-m-2 rounded-xl bg-gray-900/5 p-4 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl group lg:flex space-y-1 items-center shadow-lg grid grid-cols-2">
          ...
          <div className="lg:ml-4 col-start-2 text-wrap space-y-2">
            ...
            <div className="flex gap-5 ">
              <a href={project.live} target="_blank" className="">
              ...
              <a href={project.codebase} target="_blank" className="">
                <Button
                  variant={"destructive"}
