...
export default function page() {
  ...
  return (
    <div className="h-[90vh] max-w-5xl ">
      <div className="h-[100%] overflow-y-scroll no-scrollbar scrollbar-track-blue-lighter scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-w-2 scroll-my-28 scroll-ms-40 mb-3 scroll-smooth ">
